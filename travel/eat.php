...
<title>Eat in Tagaytay | Tungpalan - Pajarillo Wedding</title>
...
<body class="wrapper interior travel-wrapper" id="eat">
	<div class="header-bg">
	...
	<div class="banner-wrapper">
		<div class="banner">
			<div class="content-wrapper xs-12">
				<h1 class="align-center underline">Eat</h1>
			</div>
	...
	<div class="main-content content-wrapper">
		<div class="title-wrapper">
			<h2 class="xs-12 uppercase prussian-blue title"><span>Try Some Food</span></h2> 
		...
		<p class="xs-12 caption">Tagaytay is known for its food scene. Be sure to try the famous Bulalo (bone marrow soup) before leaving.</p>

		<div class="toggle-view">
			<div class="tiles group toggle-visibility invisible">
				<?php				
					while($row=$result->fetch_assoc()){
						$thumb="../images/eat/" . strtolower(str_replace("'", "", str_replace(" ", "-", $row["Name"]))) . ".jpg";
						$tile="";
				    	...
				    	$tile.="<hr>";
				    	$tile.="<p><span class='uppercase'>Cuisine:</span> <span class='turquoise-blue'>" . $row["Cuisine"] . "</span></p>";
				    	$tile.="<p><span class='uppercase'>Must Try:</span> <span class='turquoise-blue'>" . $row["MustTry"] . "</span></p>";
				    	$tile.="</div>";
			...
			<div class="map toggle-visibility xs-12 invisible">
				<iframe src="https://www.google.com/maps/d/embed?mid=1mRnM9Ka2Fs9dEG08BM7vJKlE8r7zapGA&z=13" width="100%" height="546" frameBorder="0" style="border:0; margin-top: -46px;"></iframe></iframe>
			</div>
		</div>
