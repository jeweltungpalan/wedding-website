<?php
	...
	$query="SELECT * FROM Households WHERE ElectronicSTDStatus LIKE 'To Send' AND ElectronicSTDBatch LIKE 'Batch 2' AND EmailAddress NOT LIKE ''";
	...
	while($row=$result->fetch_assoc()){
		...
		$body.="</td></tr>";
		$body.="<tr><td width='600' align='center'>";
		$body.="<a href='http://www.jurisjewelclosingthedistance.com/?utm_source=invite&utm_medium=email&utm_campaign=save_the_date&hid=" . trim($row["HouseholdID"]) . "'><img src='http://www.jurisjewelclosingthedistance.com/invite/save-the-date.jpg' alt='View Our Website www.JurisJewelClosingTheDistance.com' width='600'></a>";
		$body.="</td></tr>";
		...
		$body.="<a href='https://calendar.google.com/calendar/ical/jurisjeweltungpalan%40gmail.com/private-18ac5ec8b33c1405dc8e23821eb398a3/basic.ics'><img src='http://www.jurisjewelclosingthedistance.com/invite/save-the-date-button.jpg' alt='Add to Calendar' width='336'></a>";
		$body.="</td></tr>";
		$body.="<tr><td width='600' align='center' style='padding: 15px 0;'>";
		$body.="- Juris & Jewel";
		$body.="</td></tr>";
