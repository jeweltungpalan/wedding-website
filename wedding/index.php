...
<title>Wedding | Tungpalan - Pajarillo Wedding</title>

<body class="wrapper interior" id="faq">
	<div class="header-bg">
	...
	<div class="banner-wrapper">
		<div class="banner">
			<div class="content-wrapper xs-12">
				<h1 class="align-center underline">Our Wedding</h1>
			</div>
	...
	<div class="main-content content-wrapper xs-12 align-center">
		...
		<h2 class="uppercase">Our Wedding</h2>
		<p>Coming soon. Check back again later.</p>
	</div>
